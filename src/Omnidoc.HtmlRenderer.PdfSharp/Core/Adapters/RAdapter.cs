...
using Omnidoc.HtmlRenderer.Core;
using Omnidoc.HtmlRenderer.Core.Entities;
using Omnidoc.HtmlRenderer.Core.Handlers;
using Omnidoc.HtmlRenderer.Core.Utils;

namespace Omnidoc.HtmlRenderer.Adapters
{
    /// <summary>
    ...
    public abstract class RAdapter
    {
        ...
        public RImage GetLoadingImage()
        {
            if (_loadImage == null)
            {
                var stream = typeof(HtmlRendererUtils).Assembly.GetManifestResourceStream("Omnidoc.HtmlRenderer.Core.Utils.ImageLoad.png");
                if (stream != null)
        ...
        public RImage GetLoadingFailedImage()
        {
            if (_errorImage == null)
            {
                var stream = typeof(HtmlRendererUtils).Assembly.GetManifestResourceStream("Omnidoc.HtmlRenderer.Core.Utils.ImageError.png");
                if (stream != null)
